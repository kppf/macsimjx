...
set LINKFLAGS=-aa -c -Tpd -x -Gn -L\"%BORLAND%\"\lib\32bit -L\"%BORLAND%\"\lib -L\"%LIBLOC%\" libmx.lib libmex.lib libmat.lib c0d32.obj import32.lib cw32mt.lib "%OUTDIR%%MEX_NAME%.def" -L"%SIMCLASSLIB%\code\bin"
set LINKOPTIMFLAGS=
