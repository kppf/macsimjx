...
#
# $Revision: 1.4.2.2 $ $Date: 2004/08/20 19:18:14 $
#
...
# Original $$ variable changed to $pid since problem arose with new version of perl
srand;
$pid = int(rand(10000));
open(RSPFILE, ">$pid.rsp") || die "Can't open $pid.rsp";
print RSPFILE "$OBJ";
close(RSPFILE);

$cmd = "ilink32 $OPTION \@$pid.rsp , $DLL , , $LIB , $DEF , $RES";
if (0)
{
    $| = 1;
    print "\$OPTION = $OPTION\n";
