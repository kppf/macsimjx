...
public class SimpleSummationAgent extends UsefulAgentMethods {
     ...
     * changing.
     */
    int[] inputPortsOfInterest = {0}; // I.e. Top signal input to MACSim block.
    int[] outputPorts = {0}; // Set which ports in Simulink data is shown on.
        ...
        public void action() {
            ...
            if (msg != null) {
                ...
                if (message.equals("UpdateData")) {
                    if (debug) {
                        System.out.println("(Debug)Agent receiving new data from Simulink. ");
                        System.out.printf("\n");
                    }          
...
/**  Agent particular aspects begin here.     *****************/
                    ...
                    signal1 = dataArray[inputPortsOfInterest[0]];                 
...
/** Agent specific task inside this block *******************************************/  
                    ...
                    double signal2 = dataArray[elementsToUse[0]];

                   // Perform calculations with data from other agents.
                    
                   //In this case find the sum of both signals.
                    sum = signal1 + signal2;
